...
class Criticas(models.Model):
    id = models.IntegerField(primary_key=True)
    pelicula = models.ForeignKey('Peliculas', models.DO_NOTHING, blank=True, null=True)
...
class Peliculas(models.Model):
    ...
    director = models.ForeignKey(Directores, models.DO_NOTHING, blank=True, null=True)
    duracion = models.IntegerField(blank=True, null=True)
    estudio = models.ForeignKey(Estudios, models.DO_NOTHING, blank=True, null=True)
...
class PeliculasGeneros(models.Model):
    pelicula = models.OneToOneField(Peliculas, models.DO_NOTHING, primary_key=True)  # The composite primary key (pelicula_id, genero_id) found, that is not supported. The first column is selected.
    genero = models.ForeignKey(Generos, models.DO_NOTHING)
...
class PeliculasListas(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('pelicula', 'lista'),)


class PeliculasPaises(models.Model):
    pelicula = models.OneToOneField(Peliculas, models.DO_NOTHING, primary_key=True)  # The composite primary key (pelicula_id, pais_id) found, that is not supported. The first column is selected.
